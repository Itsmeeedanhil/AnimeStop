      ...
      >
        ...
        <div className="flex flex-col items-center text-center gap-2">
          ...
          <h2 className="font-['Bodoni_Moda'] text-2xl font-bold text-[#e2e2e2]">
            {mode === 'signin' ? 'Sign In to AnimeStop' : 'Create Your Account'}
          </h2>
        ...
        <div className="flex flex-col gap-4">
          ...
          <button
            ...
            className="w-full py-3 px-4 rounded-xl bg-[#1E2020] hover:bg-[#282a2a] border border-white/10 hover:border-[#ffe9b0]/50 text-xs font-semibold text-[#e2e2e2] flex items-center justify-center gap-3 transition-all shadow-sm cursor-pointer active:scale-[0.99] disabled:opacity-60"
          >
            {isGoogleLoading ? (
              <span className="w-4 h-4 border-2 border-[#ffe9b0] border-t-transparent rounded-full animate-spin"></span>
            ) : (
