...
import { X, AlertCircle, User as UserIcon, Mail, Lock } from 'lucide-react';
...
export default function AuthModal() {
  ...
  const handleGoogleStandardOAuth = () => {
    window.location.href = `https://accounts.google.com/o/oauth2/v2/auth?client_id=${encodeURIComponent('1067760215985-sodr8544tj6klg74qla2jhspgc2qa1vt.apps.googleusercontent.com')}&redirect_uri=${encodeURIComponent(window.location.origin + '/auth/google/callback')}&response_type=token&scope=${encodeURIComponent('openid email profile')}`;
  };
  ...
  return (
    ...
    >
      ...
      >
        ...
        {mode === 'manual_google' ? (
          <form onSubmit={handleGoogleManualSubmit} className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-1.5">
              <label className="text-xs font-semibold text-[#d0c5af]">Gmail Address</label>
              <input
                type="email"
                required
                autoFocus
          ...
          <div className="flex flex-col gap-5">
            ...
            <button
              ...
              className="w-full py-3.5 px-4 rounded-xl bg-[#1E2020] hover:bg-[#282a2a] border border-white/10 hover:border-[#ffe9b0]/50 text-xs font-semibold text-[#e2e2e2] flex items-center justify-center gap-3 transition-all shadow-sm cursor-pointer active:scale-[0.99]"
            >
              ...
              {mode === 'register' && (
                <div className="flex flex-col gap-1.5">
                  ...
                  <div className="relative">
                    ...
                    />
                    <UserIcon className="absolute left-3 top-3.5 w-4 h-4 text-[#99907c]" />
                  </div>
                </div>
              )}
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-[#121414] border border-[#4d4635] focus:border-[#ffe9b0] text-[#e2e2e2] text-xs rounded-xl pl-9 pr-3.5 py-3 outline-none transition-colors"
                  />
                  <Mail className="absolute left-3 top-3.5 w-4 h-4 text-[#99907c]" />
                </div>
              </div>
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-[#121414] border border-[#4d4635] focus:border-[#ffe9b0] text-[#e2e2e2] text-xs rounded-xl pl-9 pr-3.5 py-3 outline-none transition-colors"
                  />
                  <Lock className="absolute left-3 top-3.5 w-4 h-4 text-[#99907c]" />
                </div>
                {mode === 'register' && (
            ...
            {/* Switch between Google and manual */}
            <button
              type="button"
              onClick={() => { setMode('manual_google'); setError(''); }}
              className="text-center text-[11px] text-[#99907c] hover:text-[#ffe9b0] underline cursor-pointer"
            >
              Having trouble with popups? Click for direct Gmail login
            </button>
          </div>
        )}
      </div>
