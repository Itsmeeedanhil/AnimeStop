...
export function resolveStreamingServers(anilistId, episodeNumber = 1, malId = null, animeDetails = null) {
  ...
  const targetEpisode = episodeNumber + (tmdbInfo?.episodeOffset || 0);
      ...
      servers.push(
        {
          id: 'zoryva',
          name: 'Zoryva HD',
          url: `https://vidsrc.to/embed/tv/${tmdbId}/${seasonNumber}/${targetEpisode}`,
        },
        {
          id: 'vidsrc-me',
          name: 'VidSrc ME',
          url: `https://vidsrc.me/embed/tv?tmdb=${tmdbId}&season=${seasonNumber}&episode=${targetEpisode}`,
        },
        {
          id: 'vidlink',
          name: 'VidLink TMDB',
          url: `https://vidlink.pro/tv/${tmdbId}/${seasonNumber}/${targetEpisode}?primaryColor=ffe9b0&secondaryColor=121414`,
        },
        {
          id: '2embed',
          name: '2Embed TV',
          url: `https://www.2embed.cc/embedtv/${tmdbId}&s=${seasonNumber}&e=${targetEpisode}`,
        },
        {
          id: 'multiembed',
          name: 'MultiEmbed',
          url: `https://multiembed.mov/?video_id=${tmdbId}&tmdb=1&s=${seasonNumber}&e=${targetEpisode}`,
        }
      );
    }
  }

  // Always include Universal AniList Direct Resolver as well
  servers.push({
    id: 'vidsrc-ani',
    name: 'VidSrc Anime (Direct)',
