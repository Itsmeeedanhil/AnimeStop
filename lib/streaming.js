export function resolveStreamingServers(tmdbId, seasonNumber = 1, episodeNumber = 1, isMovie = false) {
  ...
  if (isMovie) {
    return [
      ...
      },
      {
        id: 'smashystream',
        name: 'SmashyStream',
        url: `https://embed.smashystream.com/playere.php?tmdb=${numericId}`,
      },
      {
        id: 'multiembed',
        name: 'MultiEmbed',
        url: `https://multiembed.mov/?video_id=${numericId}&tmdb=1`,
      },
      {
        id: '2embed',
        name: '2Embed Cinema',
        url: `https://www.2embed.cc/embed/${numericId}`,
      },
      {
        id: 'vidlink',
        name: 'VidLink TMDB',
  ...
  return [
    ...
    },
    {
      id: 'smashystream',
      name: 'SmashyStream',
      url: `https://embed.smashystream.com/playere.php?tmdb=${numericId}&season=${sNum}&episode=${epNum}`,
    },
    {
      id: 'multiembed',
      name: 'MultiEmbed',
      url: `https://multiembed.mov/?video_id=${numericId}&tmdb=1&s=${sNum}&e=${epNum}`,
    },
    {
      id: '2embed',
      name: '2Embed TV',
      url: `https://www.2embed.cc/embedtv/${numericId}&s=${sNum}&e=${epNum}`,
    },
    {
      id: 'vidlink',
      name: 'VidLink TMDB',
