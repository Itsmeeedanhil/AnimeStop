export function resolveStreamingServers(anilistId, episodeNumber = 1, malId = null) {
  ...
  const serversList = [
    ...
    {
      id: 'videasy',
      name: 'Videasy HD (Ad-Free)',
      url: `https://player.videasy.to/anime/${targetMalId || anilistId}/${episodeNumber}?${videasyParams}`,
    },
    {
      id: 'cinesrc',
      name: 'CineSrc HD',
    ...
    },
    {
      id: '2embed',
      name: '2Embed Clean',
      url: `https://www.2embed.cc/embedmal/${targetMalId}-${episodeNumber}`,
    },
    {
      id: 'vidsrc',
      name: 'VidSrc Alpha',
