export function resolveStreamingServers(anilistId, episodeNumber = 1, malId = null) {
  ...
  const adFreeParams = 'k=1&autoPlay=1&skipIntro=1&skipOutro=1';
  const embedBaseUrl = 'https://cdn.4animo.xyz/embed';

  return [
    {
      id: '4animo-ani',
      name: 'Server 1 (4Animo Direct)',
      badge: 'English Sub (Default)',
      url: `${embedBaseUrl}/ani/${anilistId}/${episodeNumber}/sub?${adFreeParams}`,
    },
    {
      id: '4animo-hd1',
      name: 'Server 2 (HiAnime HD-1)',
      badge: 'MegaCloud Sub',
      url: `${embedBaseUrl}/hd-1/ani/${anilistId}/${episodeNumber}/sub?${adFreeParams}`,
    },
    {
      id: '4animo-hd2',
      name: 'Server 3 (HiAnime HD-2)',
      badge: 'VidStreaming Sub',
      url: `${embedBaseUrl}/hd-2/ani/${anilistId}/${episodeNumber}/sub?${adFreeParams}`,
    },
    {
      id: 'vidlink-sub',
      name: 'Server 4 (VidLink HD)',
      badge: 'Auto English Sub',
      url: `https://vidlink.pro/anime/${targetMalId}/${episodeNumber}?primaryColor=ffe9b0&secondaryColor=1e2020&sub=en`,
    },
    {
      id: 'autoembed',
      name: 'Server 5 (AutoEmbed Multi-Sub)',
      badge: 'Multi-Lang Sub',
      url: `https://player.autoembed.cc/embed/anime/${targetMalId}/${episodeNumber}`,
    },
    {
      id: 'vidsrc-icu',
      name: 'Server 6 (VidSrc 1080p)',
      badge: '1080p Sub',
      url: `https://vidsrc.icu/embed/anime/${targetMalId}/${episodeNumber}`,
    },
  ];
}
