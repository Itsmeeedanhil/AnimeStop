...
export function resolveStreamingServers(anilistId, episodeNumber = 1, malId = null, animeDetails = null) {
  ...
  // Default to Season 1 for series
      ...
      return [
        {
          id: 'tmdb-vidlink',
          name: 'TMDB Cinema',
          url: `https://vidlink.pro/movie/${tmdbId}?primaryColor=ffe9b0&secondaryColor=121414&autoplay=false`,
        },
      ];
    }
    ...
    return [
      {
        id: 'tmdb-vidlink',
        name: 'TMDB HD',
        url: `https://vidlink.pro/tv/${tmdbId}/${seasonNumber}/${episodeNumber}?primaryColor=ffe9b0&secondaryColor=121414&autoplay=false`,
      },
    ];
  }
