...
export const AnimeApi = {
  ...
  getSeasonEpisodes: (id, season = 1) => api.get(`/anime/season/${id}/${season}`).then(res => res.data.data),
  getStream: (id, ep = 1, season = 1) => api.get(`/anime/stream/${id}/${ep}`, { params: { season } }).then(res => res.data.data),
