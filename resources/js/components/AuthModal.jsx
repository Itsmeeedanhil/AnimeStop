...
export default function AuthModal({ isOpen, onClose, onSuccess, initialMode = 'login', showNotification }) {
    const [mode, setMode] = useState(initialMode); // 'login', 'register', or 'manual_google'
    ...
    /**
     * Standard Official Google OAuth 2.0 Flow
     */
    const handleGoogleStandardOAuth = () => {
        // Direct browser navigation to standard Google OAuth 2.0 endpoint
