        ...
        <footer className="w-full bg-[#0d0f0f] border-t border-[#4d4635]/40 py-10 px-6 md:px-16 mt-auto">
            <div className="max-w-[1920px] mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
                ...
                <div className="flex flex-wrap justify-center gap-6 text-xs text-[#d0c5af]">
                    <button onClick={() => navigate('/')} className="hover:text-[#ffe9b0] transition-colors">
                        Home
                    </button>
                    <button onClick={() => navigate('/search?sort=trending')} className="hover:text-[#ffe9b0] transition-colors">
                        Trending Anime
                    </button>
                    <button onClick={() => navigate('/genres')} className="hover:text-[#ffe9b0] transition-colors">
                        Browse Genres
                    </button>
                    <button onClick={() => navigate('/library')} className="hover:text-[#ffe9b0] transition-colors">
                        My Watchlist
                    </button>
