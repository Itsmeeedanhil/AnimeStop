      ...
      <div className="flex flex-col gap-6 border-b border-[#4d4635]/40 pb-8">
        <div>
          <h1 className="font-['Bodoni_Moda'] text-3xl md:text-5xl font-bold text-[#e2e2e2] flex items-center gap-3">
            <Search className="w-8 h-8 text-[#ffe9b0]" />
            Browse & Search Anime
          </h1>
        ...
        <form onSubmit={handleSearchSubmit} className="flex gap-3">
          <div className="relative flex-1">
            <input
              ...
              placeholder="Type anime title (e.g. Solo Leveling, Demon Slayer, Jujutsu Kaisen)..."
            ...
            />
            <Search className="w-5 h-5 text-[#99907c] absolute left-4 top-1/2 -translate-y-1/2" />
          </div>
          <button
            type="submit"
